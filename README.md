...
To start an app container use this command
...
# Part 2: UPADATE THE APPLICATION
...
"docker: Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint crazy_goldberg (deafd797298a130d4ddebd23c81f8887fb67c5954ccdfda6ce87ccab04bf6ffe): Bind for 127.0.0.1:3000 failed: port is already allocated'
...
5. Still on the Cli login to Docker Hub using the command " docker login"
